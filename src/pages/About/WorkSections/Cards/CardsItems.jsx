...
export default function CardsItems({id, color, bgtext,title, text}) {
    return (
       <div key={id} className="bg-[rgba(28,20,15,1)] w-93 h-80 rounded-3xl"> 
            <div className="mx-10">
                <span className={`bg-${color} text-sm font-normal inline-block mt-14 py-2 w-36 text-center rounded-lg`}>{bgtext}</span>
